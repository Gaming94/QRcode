...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	<% if((id.equals(admin)) || (id.equals(board.getId()))) {%>
		...
		<a class="logbtn-danger" role="button" onclick="return confirm('정말 삭제하시겠습니까?')" href="dropReply.jsp?bID=<%=bID%>&bID2=<%=bID2%>">삭제&nbsp;</a>
		<a class="logbtn-primary" role="button" href="modifyReply.jsp?bID=<%=bID%>&bID2=<%=bID2%>">수정&nbsp;</a>
		<%} %>
